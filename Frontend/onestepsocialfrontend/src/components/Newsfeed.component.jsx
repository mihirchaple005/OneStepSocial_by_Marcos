...
function Newsfeed(props) {
  ...
  return (
    <div>
      ...
      <div className='mt-12'><p className="bg-slate-200 text-cyan-950 font-indie rounded-md  overflow-clip hover:overflow-y-scroll text-[10px] w-[15rem] h-20 relative sm:right-[0.9rem] right-[1.3rem] sm:w-[19rem] lg:w-[27rem] md:w-[20.5rem] md:right-[1.2rem] lg:right-[1.3rem] md:text-[15px] lg:h-16 lg:text-[15px] md:h-16 text-lg">
        {props.description}
      </p></div>
